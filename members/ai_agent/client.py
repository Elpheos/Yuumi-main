...
- REGLE IMPORTANTE - VARIER LE STYLE NE VEUT PAS DIRE CHANGER DE TYPE DE COMMERCE : si la demande nomme un type de commerce ou de produit precis (ex: "burger", "tacos", "kebab") tout en demandant quelque chose de "plus original", "moins classique", ou "different", cela signifie une variante DANS LA MEME CATEGORIE - pas un changement vers une categorie totalement differente. Ex: "un burger-tacos-kebab mais plus original" reste dans la restauration rapide (categorie restauration-rapide ou equivalente) ; cela ne devient PAS une demande de restaurant traditionnel ou de cuisine du monde classique. Le mot "original" qualifie le COMMERCE a l'interieur d'une categorie deja identifiee, il ne redefinit pas la categorie elle-meme. N'ajoute une categorie differente que si la demande le justifie explicitement (ex: "plutot un restaurant assis qu'un fast-food").
